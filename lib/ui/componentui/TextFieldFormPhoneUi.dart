...
class TextFieldFormPhoneUi extends StatelessWidget {
  ...
  const TextFieldFormPhoneUi({Key key, this.textEditingController, this.focusNode, this.ownFocusNode, this.hintValue, this.isSecure, this.textInputType, this.prefixIcon, this.suffixIcon, this.errorTitle, this.max, this.min, this.contentPadding, this.contentPaddingTop, this.fontSizeError}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return TextFormField(focusNode:ownFocusNode ,onFieldSubmitted: (value){
      ...
      {
        return DemoLocalizations.of(context).title['invalidePhone'];
      }
      return null;
